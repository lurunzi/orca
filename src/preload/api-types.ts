...
import type { OrchestrationIdentityApi } from "./api/orchestration-identity-api";
...
import type {
  WorkspaceCleanupApi,
  WorkspaceSpaceApi,
} from "./api/workspace-cleanup-api";
import type {
  LocalhostWorktreeLabelsApi,
  WorkspacePortsApi,
} from "./api/workspace-port-api";
import type { WorkspaceSessionApi } from "./api/workspace-session-api";
import type {
  FolderWorkspacesApi,
  SparsePresetsApi,
  WorktreeApi,
} from "./api/worktree-api";
...
export type PreloadApi = {
  ...
  orchestrationIdentity?: OrchestrationIdentityApi;
  fs: FilesystemApi["fs"];
